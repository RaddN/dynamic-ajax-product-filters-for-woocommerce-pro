    ...
    blocks.registerBlockType( 'plugin/dynamic-ajax-filter', {
        ...
        attributes: {
            filterOptions: { type: 'array', default: [
                { id: "product-category", title: "product-category", visible: true },
        ...
        edit: function( props ) {
            ...
            const [filterOptions, setFilterOptions] = useState(attributes.filterOptions || ["product-category",'tag' ,'price-range','rating','search_text']);
            ...
            useEffect(() => {
                const fetchAttributes = async () => {
                    try {
                        const response = await fetch('/wp-json/dynamic-ajax-product-filters-for-woocommerce-pro/v1/attributes/');
                        if (!response.ok) {
            ...
            return [
                el( InspectorControls, {},
                    el( TabPanel, {
                        className: 'plugincyajaxfilter-tab-panel',
                        ...
                        if ( tab.name === 'general' ) {
                            ...
                            return [
                                ...
                                el( PanelBody, { title: 'Rating Style', initialOpen: false },
                                    el( 'p', {}, 'Rating Size' ),
                                    el( RangeControl, {
                                        value: attributes.ratingStyle["width"],
                                        onChange: function( value ) {
                                            setAttributes( { ratingStyle: { ...attributes.ratingStyle, "width": value } } );
                                        }
                                    } ),
                                    el( 'p', {}, 'Inactive Color' ),
                                    el( ColorPalette, {
                                        value: attributes.ratingStyle["fill"],
                                        onChange: function( value ) {
                                            setAttributes( { ratingStyle: { ...attributes.ratingStyle, "fill": value } } );
                                        }
                                    } ),
                                    el( 'p', {}, 'Active Color' ),
                                    el( ColorPalette, {
                                        value: attributes.ratingStyle.activefillColor,
                                        onChange: function( value ) {
                                            setAttributes( { ratingStyle: { ...attributes.ratingStyle, activefillColor: value } } );
                                        }
                                    } ),
                                    el( 'p', {}, 'Hover Color' ),
                                    el( ColorPalette, {
                                        value: attributes.ratingStyle.hoverfillColor,
                                        onChange: function( value ) {
                                            setAttributes( { ratingStyle: { ...attributes.ratingStyle, hoverfillColor: value } } );
                                        }
                                    } ),
                                ), 
