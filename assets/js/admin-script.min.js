...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Close popup when clicking outside of it or pressing Escape
    document.addEventListener('mousedown', function (e) {
        if (popup && popup.style.display === 'flex') {
            const popupContent = popup.querySelector('.popup-content');
            if (popupContent && !popupContent.contains(e.target) && e.target !== customizeLoaderLink) {
                popup.style.display = 'none';
            }
        }
    });
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function toggleInputs() {
        ...
        const inputsAndSelects = secondTable.querySelectorAll('input:not([name="dapfforwc_seo_permalinks_options[enable_seo]"]), select,textarea');
