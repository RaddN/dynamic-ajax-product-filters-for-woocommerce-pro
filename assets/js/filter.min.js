...
<<<<<<< HEAD
        spinnerClass: 'dapfforwcpro-spinner',
        loadingClass: 'dapfforwcpro-loading',
=======
...
>>>>>>> bffd825023297ffa4a9003fb4c1fdd5eb3a2e003
    ...
    if (typeof dapfforwcpro_data !== 'undefined') {
        ({
            dapfforwcpro_advance_settings: advancesettings,
            dapfforwcpro_front_page_slug: front_page_slug,
            dapfforwc_options,
            dapfforwc_seo_permalinks_options
        } = dapfforwcpro_data);
    }

    if (typeof dapfforwcpro_ajax !== 'undefined') {
        ({
            shopPageUrl,
            isProductArchive,
            currencySymbol,
...
<<<<<<< HEAD
        const $form = $(dapfforwcpro_FILTER.formSelector);
=======
...
<<<<<<< HEAD
            if (event.state && event.state.dapfforwcproFilter) {
=======
...
<<<<<<< HEAD
        $form.on('change', dapfforwcpro_FILTER.filterTriggers, function () {
=======
...
<<<<<<< HEAD
            }, dapfforwcpro_FILTER.debounceTime);
=======
...
<<<<<<< HEAD
        $form.on('click', dapfforwcpro_FILTER.searchButton, function (e) {
=======
...
<<<<<<< HEAD
        $(dapfforwcpro_FILTER.searchField).on('keypress', function (e) {
=======
...
<<<<<<< HEAD
        let orderBy = $(dapfforwcpro_FILTER.sortingSelector).val() === "menu_order" ? product_show_settings.orderby : $(dapfforwcpro_FILTER.sortingSelector).val();          // "date"
=======
...
<<<<<<< HEAD
        const $form = $(dapfforwcpro_FILTER.formSelector);
        // Remove any 'filters/...' segment from the end of currentUrl
...
>>>>>>> bffd825023297ffa4a9003fb4c1fdd5eb3a2e003
        ...
        filterState.currentRequest = $.ajax({
            ...
            success: function (response) {
                if (response.success) {
                    if (dapfforwc_options.use_url_filter === "query_string") {
...
<<<<<<< HEAD
                            window.history.pushState({ dapfforwcproFilter: true }, '', url);
=======
...
>>>>>>> bffd825023297ffa4a9003fb4c1fdd5eb3a2e003
                        ...
                        if (dapfforwc_seo_permalinks_options &&
                            ...
                            // Update the browser history
<<<<<<< HEAD
                            window.history.pushState({ dapfforwcproFilter: true }, '', seoUrl);
                        }
                    } else if (dapfforwc_options.use_url_filter === "permalinks") {
                        // Update browser history / url with transformed URL if necessary
                        if (dapfforwc_seo_permalinks_options &&
                            dapfforwc_seo_permalinks_options.use_attribute_type_in_permalinks !== "on") {
                            let selectedValuesByUser = store_selected_values(); // Assuming this returns an object
                        ...
                        if (dapfforwc_seo_permalinks_options &&
                            ...
                            url = currentUrl + url.substring(url.indexOf('?'));
                            // Transform the URL to SEO format
                            let seoUrl = transformToSeoUrl(url, dapfforwc_seo_permalinks_options, true).replace(/%2C/g, ',').replace(/\?/g, '').replace(/&/g, '/').replace(/filters=/g, 'filters');
...
<<<<<<< HEAD
                    $(document).trigger('dapfforwcpro_filters_updated');
=======
...
<<<<<<< HEAD
        $(document).on('change', dapfforwcpro_FILTER.sortingSelector, function (e) {
=======
...
<<<<<<< HEAD
        ...
        if ($orderbyInput.length === 0) {
            ...
            $(dapfforwcpro_FILTER.formSelector).append($orderbyInput);
        } else {
...
<<<<<<< HEAD
        ...
        handleFilterChange($(dapfforwcpro_FILTER.formSelector));
=======
            // Trigger filter change with the new sort order
...
>>>>>>> bffd825023297ffa4a9003fb4c1fdd5eb3a2e003
    ...
    function setLoadingState(isLoading) {
        ...
        if (isLoading && isloadingenablebyadmin) {
            ...
            showSpinner();
<<<<<<< HEAD
            $(dapfforwcpro_FILTER.formSelector).addClass(dapfforwcpro_FILTER.loadingClass);
        } else {
            $('html, body').css('cursor', 'auto');
            hideSpinner();
            $(dapfforwcpro_FILTER.formSelector).removeClass(dapfforwcpro_FILTER.loadingClass);
=======
...
>>>>>>> bffd825023297ffa4a9003fb4c1fdd5eb3a2e003
    ...
    function changePseudoElementContent(minValue, maxValue, activeHandle = null) {
        ...
        const minPriceDefault = parseInt($('.range-min').attr('min')) || 0;
        const maxPriceDefault = parseInt($('.range-max').attr('max')) || 100;
    ...
    function initPriceRangeInputs() {
        ...
        let maxPrice = parseInt($rangeInputs[1].value) + 1 || 0;
        ...
        $rangeInputs.on("input", function () {
            ...
            maxPrice = parseInt($rangeInputs.eq(1).val()) + 1 || 0;
...
>>>>>>> bffd825023297ffa4a9003fb4c1fdd5eb3a2e003
    ...
    function scrollToProducts() {
        ...
        if ($target.length > 0) {
            $('html, body').animate({
<<<<<<< HEAD
                scrollTop: $target.offset().top - dapfforwcpro_FILTER.autoScrollOffset
=======
...
>>>>>>> bffd825023297ffa4a9003fb4c1fdd5eb3a2e003
        ...
        const attrprefix = dapfforwc_seo_permalinks_options.dapfforwcpro_permalinks_prefix_options;
        ...
        if (attrprefix && attrprefix["product-category"]) {
            prefixToAttribute[attrprefix["product-category"]] = "cata";
        }
        if (attrprefix && attrprefix.tag) {
            prefixToAttribute[attrprefix.tag] = 'tag';
        }
        if (attrprefix && attrprefix.price) {
            prefixToAttribute[attrprefix.price] = 'price';
        }
        if (attrprefix && attrprefix.rating) {
...
<<<<<<< HEAD
                        const $minInput = $form.find('input.dapfforwcpro-filters-range-min');
                        const $maxInput = $form.find('input.dapfforwcpro-filters-range-max');
=======
...
>>>>>>> bffd825023297ffa4a9003fb4c1fdd5eb3a2e003
     ...
     */
    function transformToSeoUrl(url, seoOptions, ispermalinks = false) {
        if (!url || !seoOptions) {
        ...
        if (!ispermalinks) {
            ...
            seoParams.append('filters', ''); // Add the permalinks=1 parameter
        }

        // Prefixes config from SEO options
        const prefixes = seoOptions.dapfforwcpro_permalinks_prefix_options;

        // Process category parameters
        if (searchParams.has("product-category[]")) {
            const categories = searchParams.getAll("product-category[]");
            if (categories.length > 0) {
                const catakey = (prefixes && prefixes["product-category"]) ?? "cata";
        ...
        if (searchParams.has('tags[]')) {
            ...
            if (tags.length > 0) {
                const tagskey = (prefixes && prefixes["tag"]) ?? "tags";
        ...
        if (searchParams.has('rating[]')) {
            ...
            if (ratings.length > 0) {
                const ratingKey = (prefixes && prefixes["rating"]) ?? "rating";
