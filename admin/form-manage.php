...
function dapfforwcpro_render_checkbox($key, $settings = "dapfforwc_options")
{
    global $$settings;
?>
...
function dapfforwcpro_show_categories_render()
{
    dapfforwcpro_render_checkbox('show_categories');
}
function dapfforwcpro_show_attributes_render()
{
    dapfforwcpro_render_checkbox('show_attributes');
}
function dapfforwcpro_show_tags_render()
{
    dapfforwcpro_render_checkbox('show_tags');
}
function dapfforwcpro_show_price_range_render()
{
    dapfforwcpro_render_checkbox('show_price_range');
}
function dapfforwcpro_show_rating_render()
{
    dapfforwcpro_render_checkbox('show_rating');
}
function dapfforwcpro_show_search_render()
{
    dapfforwcpro_render_checkbox('show_search');
}
function dapfforwcpro_use_filters_word_in_permalinks_render()
{
    dapfforwcpro_render_checkbox('use_filters_word_in_permalinks', 'dapfforwc_seo_permalinks_options');
}

function dapfforwcpro_update_filter_options_render()
{
    dapfforwcpro_render_checkbox('update_filter_options');
}
function dapfforwcpro_show_loader_render()
{
    dapfforwcpro_render_checkbox('show_loader');
}
function dapfforwcpro_use_custom_template_render()
{
    dapfforwcpro_render_checkbox('use_custom_template');
}




function dapfforwcpro_custom_template_code_render()
{
...
function dapfforwcpro_use_url_filter_render()
{
    global $dapfforwc_options;
?>
    <fieldset>
