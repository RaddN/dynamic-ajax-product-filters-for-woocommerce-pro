...
function dapfforwcpro_admin_page_content() { global $dapfforwc_options;
    ?>
            ...
            if ($active_tab == 'form_manage') {
                ...
                <div id="custom-loading-popup" style="display:none;" >
                    <div class="popup-content">
                        ...
                        <textarea id="loader_html" placeholder="html values will be here" name="dapfforwc_options[loader_html]"><?php 
                        ...
                        <textarea id="loader_css" placeholder="CSS values will be here" name="dapfforwc_options[loader_css]"><?php 
                    ...
                    <tbody>
                        <tr>
                            ...
                            <form method="post" enctype="multipart/form-data" action="<?php echo esc_url(admin_url('admin-post.php')); ?>">
                                ...
                                <input type="hidden" name="action" value="dapfforwcpro_import_settings">
                                <input type="file" name="dapfforwcpro_import_file" accept=".json" required>
                        ...
                        <td>
                            <form method="post" action="admin-post.php">
                                <input type="hidden" name="action" value="dapfforwcpro_export_settings">
